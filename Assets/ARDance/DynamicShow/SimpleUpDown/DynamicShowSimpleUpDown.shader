Shader "Unlit/DynamicShowSimpleUpDown"
{
    Properties
    {
        _MainTex ("_MainTex", 2D) = "white" {}
        _Threshold ("_Threshold", Range(-0.1, 1.0)) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                if (i.uv.y > _Threshold + _EmissionRange) {
                    discard;
                }
                float emissionVal = step(_Threshold, i.uv.y);
